...
# c.IPClusterStart.work_dir = u'/home/data/setup'
...
# Set the working dir for the process.
# c.IPClusterEngines.work_dir = u'/home/data/setup'
...
# c.LocalControllerLauncher.controller_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.controller']
...
# c.LocalEngineLauncher.engine_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.LocalEngineSetLauncher.engine_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.MPIControllerLauncher.controller_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.MPIEngineSetLauncher.engine_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.engine']
...
# Popen command to launch ipcontroller.
# c.SSHControllerLauncher.controller_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.controller']
...
# command to launch the Engine.
# c.SSHEngineLauncher.engine_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.engine']
...
# command to launch the Engine.
# c.SSHEngineSetLauncher.engine_cmd = ['/root/anaconda/envs/py27/bin/python', '-m', 'IPython.parallel.engine']
